- **Modelos**
  ...
  - [Agendamento - Serviço](documentacao/view_agendamento_servico/)

  <!-- Pessoa-related -->
  - [Alertas de Pacientes](documentacao/view_pessoa_alerta/)

  <!-- Clinical documentation (evolução, prescrições, prontuários) -->
  ...
  - [Relatórios Médicos](documentacao/view_prescricao_relatorio_medico/)
